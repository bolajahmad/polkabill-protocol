module.exports = class Data1774004919372 {
    name = 'Data1774004919372'
    ...
    async up(db) {
        ...
        await db.query(`CREATE TABLE "charge" ("id" character varying NOT NULL, "amount" numeric NOT NULL, "chain_id" integer NOT NULL, "token" text NOT NULL, "payout_address" text NOT NULL, "billing_cycle" numeric NOT NULL, "tx_hash" text NOT NULL, "block_number" numeric NOT NULL, "success" boolean NOT NULL, "created_at" TIMESTAMP WITH TIME ZONE NOT NULL, "nonce" numeric NOT NULL, "subscription_id" character varying, "adapter_id" character varying, CONSTRAINT "PK_ac0381acde3bdffe41ad57cd942" PRIMARY KEY ("id"))`)
